...
\item this cn be cut by investing in renevable sources of energy and rapid expansion
\item 
\end{itemize}
\subsubsection{Improvement}
...
\subsubsection{Review}
\begin{itemize}
\item iN china we can do $1 Mt CO_2e$; its called here \emph{island grid}
\end{itemize}
\subsubsection{Improvement}
